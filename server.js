...
function resolveBinary() {
  ...
  const candidates = [
    ...
    path.join(__dirname, 'bin', `${process.platform}-${process.arch}`, binName), // ./bin/<platform-arch>/pocketbase(.exe)
  ];
...
function printMissingBinaryHelp() {
  ...
  console.error('place/rename it as noted above, then re-run your command.\n');
}
